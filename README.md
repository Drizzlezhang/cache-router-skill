...
Using Claude Code, type: "Refer to https://github.com/Drizzlezhang/cache-router-skill/blob/main/README.zh-CN.md, install this skill globally / for this project"
